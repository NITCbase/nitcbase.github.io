...
NITCbase supports two user interfaces namely, [XFS Interface](../XFS%20Interface/introduction.md) and [Frontend Interface](../Design/Frontend.md). The commands supported by the two interfaces have overlap and they fall into the following **four** categories:
