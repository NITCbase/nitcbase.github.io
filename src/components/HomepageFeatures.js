  ...
  return (
    <section className={styles.features}>
      <div className="container">
        ...
        <p>
            The database system design has a seven layer <a href="docs/System Design/DesignDiagram">design</a>, starting from the Physical layer at the bottom  (a disk simulator provided to the student) progressing to Buffer layer, B+tree layer, Block access layer, Cache layer, Algebra layer and Schema layer at the intermediate levels and a Front-end command-line interface for user interface at the top.    All except the front-end and the physical layer completely implemented by the student, following the instructions of the road map (writing around 3000 lines of C++ code). 
        </p> 
        <p>
            The project assumes that the student has adequate background in programming in C/C++ and data structures.
        </p>
        <p> To begin with the project. Continue to the <a href="docs/intro">Roadmap</a>
        </p>
        </div>
      </div>
    </section>
